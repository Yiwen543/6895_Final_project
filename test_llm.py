...
TESTS = [
    ...
    ("direct_command — light on",      "Cathey, turn on the light",            "direct_command"),
    ("direct_command — AC temp",       "Cathey, set the AC to 24 degrees",     "direct_command"),
    ("direct_command — close curtain", "Cathey, close the curtain",            "direct_command"),
    ("needs_clarification — cold",     "Cathey, I feel cold",                  "needs_clarification"),
    ("needs_clarification — dark",     "Cathey, it's a bit dark in here",      "needs_clarification"),
    ("general_qa — food",              "Cathey, how do I make scrambled eggs", "general_qa"),
    ("general_qa — cleaning",          "Cathey, how do I clean a sofa",        "general_qa"),
